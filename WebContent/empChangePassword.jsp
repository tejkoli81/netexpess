		...
		<div class="row">
			...
			<div class="col-md-6" data-aos-delay="100">
				<div class="icon-box">
					...
					<form action="EmployeeChangePassword" method="POST">
						<table class="table table-bordered">
							<tr>
								<td>Current Password</td>
								<td><input type="password" name="c_password" required="required"></td>
							</tr>
							
							<tr>
								<td>New Password</td>
								<td><input type="password" name=n_password	required="required"></td>
							</tr>
							<tr>
								<td></td>
								<td>
