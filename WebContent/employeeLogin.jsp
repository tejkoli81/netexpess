...
<body style="background: url('photos/Employee.jpg')no-repeat;background-size: cover;  ">
...
System.out.println("Empl Type "+emp_type);
...
%>
		...
		<div class="row">
			...
			<div class="col-md-6" data-aos-delay="100">
				<div class="icon-box">
					<h2 align="center" style="color: red;"><%=emp_type %> Login</h2>
					<form action="EmployeeLogin" method="POST">
						<table class="table table-bordered">
							...
							<tr>
								...
								<input type="hidden" value="<%=emp_type%>" name="emp_type">
								</td>
							</tr>
							<tr>
								<td>Password</td>
