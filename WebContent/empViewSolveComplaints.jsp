						...
						<%
							...
							int sr_no=0;
								...
								while(rs.next())
								{
									...
									Map<String,String> u_details=gf.getUserDetails(cust_email);
									Map<String,String> e_details=GlobalFunction.getEmployeeDetails(rs.getString("solved_by"));
									
						%>
						<tr>
							<td><%=sr_no%></td>
							<td><%=u_details.get("name")%>&nbsp;<%=u_details.get("lname")%><br />
								Mobile: <%=u_details.get("lname")%><br /> Address: <%=u_details.get("address")%><br />
							</td>

							<td style="width: 30%;">ComplaintDate:&nbsp;<%=rs.getString("cmp_date")%><br />
							...
							%>
								<form>
									<textarea rows="" cols="" name="trobleshot" required></textarea>
									<br /> <a href="UpdateComplaint?id=<%=id%>">Resolved</a>
								</form> <%}
							else
							{
							%>
							...
							<td>Name: <%=e_details.get("name") %><br /> Mobile: <%=e_details.get("mobile") %><br />
							</td>
						</tr>
						<%
							}
