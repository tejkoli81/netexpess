	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<div class="icon-box">
					<img src="photos/emp.png" style="width: 100%; height: 100%">
					<hr />
					<a href="employeeReg.jsp">Click Here For Add Employee</a>
				</div>
...
String emp_type="ServiceEngineer";

%>
				<div class="icon-box">
					<h2 align="center" style="color: red;">View All <%=emp_type %>
						Details</h2>
				...
				while(rs.next())
				{
					...
					%>
						...
						<tr>
							...
							<td><%=rs.getString("e_addr") %></td>
							<td><a href="adminupdateemp.jsp?id= <%=rs.getString("e_id")%>">Edit_Profile</a> <a href="Deleteemp?id= <%=rs.getString("e_id")%>">Delete</a>  </td>
						</tr>
						<%
				}
				%>
