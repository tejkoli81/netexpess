...
<body>
	...
	<div
		...
		<a> <img src="photos/Logo_super.jpeg" style="width: 20%; height: 20%;"></a>
	...
	<div class="container" data-aos="fade-up">
			...
			<div class="col-md-12" data-aos-delay="100">
				<div class="icon-box">
					...
					<table class="table table-bordered">
						...
						String id=request.getParameter("recharge");
						
						
						
						
						PreparedStatement ps=con.prepareStatement("SELECT * FROM bill where email='"+email+"'AND recharg_date='"+id+"'");
						...
						<tr>
							...
							<td><%=customer_details.get("name") %></td>
        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="sub-heading">Bill Date: <%=rs.getString("id") %></p>
        ...
        <div class="body-section">
            ...
            <br>
            <h3 class="heading">Installation Status:</h3>
