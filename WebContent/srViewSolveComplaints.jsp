...
<body>
	...
	<div
		...
		<nav id="navbar" class="navbar"> <%@ include
			file="Header/srEnggHeader.jsp"%> <i
					...
					<table class="table table-bordered">
						...
						<%
							...
							int sr_no=0;
								...
								PreparedStatement ps=con.prepareStatement("SELECT * FROM `complaint_details` where status='Resolved' AND solved_by='"+email+"' ORDER BY id DESC");
						...
						<tr>
							...
							%>
							<form>
								<textarea rows="" cols="" name="trobleshot" required></textarea><br/>
								<a href="UpdateComplaint?id=<%=id%>">Resolved</a>
							</form>	
							<%}
							else
							{
