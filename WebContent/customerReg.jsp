...
<body style="background: url('photos/register.jpg')no-repeat;background-size: cover;  ">
        ...
        <div class="col-md-3"></div>
          <div class="col-md-6" data-aos-delay="100">
            <div class="icon-box" style="font-family:'Times New Roman'">
              <h2 align="center" style="color: red;font-family:'Times New Roman'">Customer Registration</h2>
              <form action="CustomerRegistration" method="POST" name="ureg">
