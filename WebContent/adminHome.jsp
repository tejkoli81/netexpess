...
<body >
	...
	<br />
	<br />
	 <section id="hero" class="d-flex justify-cntent-center align-items-center" style="background-image: url('photos/admin.jpg'); " >
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
		...
		<div class="row">
			...
			<div class="col-md-6" data-aos-delay="100">
				<div class="icon-box">
					<h2 align="center" style="color: red;">Welcome Admin</h2>
