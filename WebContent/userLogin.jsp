...
<body  style="background: url('photos/login.jpg')no-repeat;background-size: cover;  ">
	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row">
			...
			<div class="col-md-6" data-aos-delay="100">
				<div class="icon-box">
					<h2 align="center" style="color: red;">User Login</h2>
					<form action="CustomerLogin" method="POST">
						...
						<center>New Account? <a href="customerReg.jsp">Register</a></center>
					</form>
				</div>
			</div>
			<div class="col-md-3"></div>
