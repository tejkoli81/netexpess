...
<h2 align="center" style="color: red;">Edit Plan</h2>
					<form action="Updatecust" method="POST" name="ureg">
                <table class="table table-bordered" >
                  <tr>
                    <td><b>First name:</b></td>
                    <input type="hidden" name="id" value="<%=id %>">
                    <td><input type="text" name="fname" value="<%=rs.getString("cust_name") %>"onblur="return AllowAlphabet()" required></td>
                  </tr>
                  
                  <tr>
                    <td><b>Last name:</b></td>
                    <td><input type="text" name="lname" value="<%=rs.getString("lname") %>"onblur="return AllowAlphabet()" required></td>
                  </tr>
                  ...
                  <tr>
                    <td><b>Mobile No:</b></td>
                    <td><input type="text" name="contact" value="<%=rs.getString("cust_ph") %>"onblur="return Validate()" required></td>
                  </tr>
                  <tr>
                    <td><b>Address:</b></td>
                    <td><textarea name="address" rows="3" cols="20" required><%=rs.getString("cust_addr") %>"</textarea></td>
                  </tr>
                  <tr>
                    <td><b>Email:</b></td>
                    <td><input type="text" name="email" onblur="return validEmail()" value="<%=rs.getString("cust_email") %>" required></td>
                  </tr>
                  <tr>
                    <td><b>Password:</b></td>
